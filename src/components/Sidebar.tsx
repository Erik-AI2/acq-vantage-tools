...
import { getItems, createItem, deleteItem } from '../api/storage'
...
export function Sidebar({ activeId, onSelect, onNew, onDelete, model, onModelChange, refreshKey }: SidebarProps) {
